...
import static christmas.domain.EventBadgeDomain.SANTA;
import static christmas.domain.EventBadgeDomain.STAR;
import static christmas.domain.EventBadgeDomain.TREE;
import static org.junit.jupiter.api.Assertions.assertEquals;

public class EventBadgeDomainTest {
    private static TotalPrice totalPrice;
    private static EventBadgeDomain eventBadgeDomain;

    @BeforeAll
    public static void testSetUp() {
        totalPrice = TotalPrice.getInstance();
        eventBadgeDomain = new EventBadgeDomain();
    }
